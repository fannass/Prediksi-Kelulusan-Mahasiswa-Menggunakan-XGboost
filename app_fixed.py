...
st.markdown("""
    <style>
        ...
        /* Better visibility for Streamlit elements */
        .element-container {
...
with col2:
    ...
    st.markdown("""
        <div class="header">
            <div class="icon-large"><span class="emoji">🎓</span></div>
...
def user_input_features():
    ...
    st.sidebar.markdown('<p style="font-weight: 600; color: #6C63FF; margin-bottom: 10px;">📌 Informasi Pribadi</p>', unsafe_allow_html=True)
    ...
    st.sidebar.markdown('<div class="input-container">', unsafe_allow_html=True)
    st.sidebar.markdown('<p style="font-weight: 600; color: #6C63FF; margin-bottom: 10px;">📚 Nilai Akademik</p>', unsafe_allow_html=True)
...
with col_main1:    # Display user input before encoding in a card
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<h4 style="color: #6C63FF; margin-bottom: 15px;">👤 Data Mahasiswa</h4>', unsafe_allow_html=True)
    st.dataframe(input_df, use_container_width=True)
    
    # Visualisasi IPS
    st.markdown('<h5 style="margin-top: 20px;"><span class="emoji">📊</span> Tren Nilai IPS</h5>', unsafe_allow_html=True)
...
with col_main2:
    ...
    if model is not None and st.button("🔮 Prediksi Status Kelulusan"):
        ...
        st.markdown("💡 **Catatan**: Prediksi ini berdasarkan model XGBoost yang telah dilatih. Hasil aktual dapat berbeda tergantung pada faktor lain.", unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
        ...
        st.markdown("""
            <div style="text-align: center; padding: 30px 0;">
                <div style="font-size: 48px; color: #6C63FF; margin-bottom: 10px;">🔮</div>
...
with col2:
    ...
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<h4 style="color: #6C63FF; margin-bottom: 15px;">ℹ️ Tentang Model</h4>', unsafe_allow_html=True)
    st.markdown("""
    ...
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<h4 style="color: #6C63FF; margin-bottom: 15px;">💡 Tips Kelulusan</h4>', unsafe_allow_html=True)
    st.markdown("""
